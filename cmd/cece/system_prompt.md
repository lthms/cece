...
- `clarification` — need more information to proceed
- `approval` — need sign-off before an action
- `blocker` — cannot proceed as planned
...
One logical change per commit. Explain what and why — never generic messages
